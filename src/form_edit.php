    ...
    <div class="container">
      <div>
        ...
        <div class="mb-3">
          ...
          <input type="text" id="numNIS" name="numNIS" class="form-control" value="<?php echo $pessoa['NUMERO_NIS']; ?>" required />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <div class="">
            <label for="outro" class="form-label">Outro: </label> <input type="text" name="outroEstadoCivil" id="outro" class="form-control" value="<?php echo $pessoa['OUTRO_ESTADO_CIVIL']; ?>" required />
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" id="profissao" name="profissao" class="form-control" value="<?php echo $pessoa['OCUPACAO_PROFISSIONAL']; ?>" required />
        </div>
        <div>
          <label for="renda" class="form-label">Renda</label>
          <input type="text" id="renda" name="renda" class="form-control" value="<?php echo $pessoa['RENDA']; ?>" required />
        </div>
        <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <div>
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="cep" name="cep" value="<?php echo $pessoa['NUMERO_NIS']; ?>" required />
          </div>
          <div class="row">
            <div class="col">
            ...
            <div class="col">
              ...
              <input type="text" class="form-control" id="numero" name="numero" value="<?php echo $pessoa['END_NUM']; ?>" required>
            </div>
          </div>
          <div class="mb-3">
            <label for="bairro" class="form-label">Bairro</label>
            <input type="text" class="form-control" id="bairro" name="bairro" value="<?php echo $pessoa['END_BAIRRO']; ?>" required>
          </div>
          <div class="mb-3">
            <label for="referencia" class="form-label">Ponto de Referência</label>
            <input type="text" class="form-control" id="referencia" name="referencia" value="<?php echo $pessoa['END_P_REFERENCIA']; ?>" required>
          </div>
          <div class="mb-3">
            <label for="telefone" class="form-label">Telefone para contato</label>
            <input type="text" class="form-control" id="telefone" name="telefone" value="<?php echo $pessoa['TELEFONE']; ?>" required>
          </div>
