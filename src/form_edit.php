...
<body style="background-color: #1E3357;">
  ...
  <form action="form.php" method="post" id="myForm" onsubmit="return validarFormulario()" class="mb-4 mx-2">
    <div class="container border rounded-4 col-md-6 col-xl-4 shadow-sm" style="background-color: white;">
      <div class="mx-auto">
        <h5 class="text-center mt-4 mb-3">Identificação</h5>

        <div class="mb-3">
          <label for="nomeCompleto" class="form-label">Nome Completo:</label>
          <input type="text" id="nome" name="nome" class="form-control bg-body-tertiary" value="<?php echo $pessoa['NOME']; ?>" required />
        </div>
        <div class="row mb-3">
          <div class="col-md-6">
            <label for="dataNascimento" class="form-label">Data de Nascimento:</label>
            <input type="text" id="dataNascimento" name="dataNascimento" class="form-control bg-body-tertiary" value="<?php echo $pessoa['DATA_NASC']; ?>" required />
          ...
          <div class="col-md-6">
            ...
            <input type="text" id="cpf" name="cpf" class="form-control bg-body-tertiary" value="<?php echo $pessoa['CPF']; ?>" required />
          </div>
        </div>
        <div class="mb-3">
          <label for="numNIS" class="form-label">Número do NIS:</label>
          <input type="text" id="numNIS" name="numNIS" class="form-control bg-body-tertiary" value="<?php echo $pessoa['NUMERO_NIS']; ?>" required />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <div class="form-check form-check-inline">
            <input type="radio" name="estadoCivil" id="solteiro" value="solteiro" class="form-check-input" <?php echo ($pessoa['ESTADO_CIVIL'] == 'solteiro' ? 'checked' : '') ?> /><label for="solteiro" class="form-check-label">Solteiro</label>
          </div>
          <div class="form-check form-check-inline ">
            <input type="radio" name="estadoCivil" id="casado" value="casado" class="form-check-input" <?php echo ($pessoa['ESTADO_CIVIL'] == 'casado' ? 'checked' : '') ?> /><label for="casado">Casado</label>
          </div>
          <div class="form-check form-check-inline ">
            <input type="radio" name="estadoCivil" id="divorciado" value="divorciado" class="form-check-input" <?php echo ($pessoa['ESTADO_CIVIL'] == 'divorciado' ? 'checked' : '') ?> /><label for="divorciado">Divorciado</label>
          </div>
          <div class="form-check  form-check-inline">
            <input type="radio" name="estadoCivil" id="uniaoEstavel" value="uniaoEstavel" class="form-check-input" <?php echo ($pessoa['ESTADO_CIVIL'] == 'uniaoEstavel' ? 'checked' : '') ?> /><label for="uniaoEstavel">União Estável</label>
          </div>
          <div class="">
            <label for="outro" class="form-label">Outro: </label> <input type="text" name="outroEstadoCivil" id="outro" class="form-control bg-body-tertiary" value="<?php echo $pessoa['OUTRO_ESTADO_CIVIL']; ?>" required />
          </div>
        </div>
        ...
        <div class="mb-3">
          ...
          <br>
          <div class="form-check form-check-inline">
            <input type="radio" name="cor" id="branca" value="branca" class="form-check-input" <?php echo ($pessoa['COR_RACA'] == 'branca') ? 'checked' : '' ?> required /><label for="branca">Branca</label>
          </div>
          <div class="form-check form-check-inline">
            <input type="radio" name="cor" id="preta" value="preta" class="form-check-input" <?php echo ($pessoa['COR_RACA'] == 'preta') ? 'checked' : '' ?> /><label for="preta">Preta</label>
          </div>
          <div class="form-check  form-check-inline">
            <input type="radio" name="cor" id="parda" value="parda" class="form-check-input" <?php echo ($pessoa['COR_RACA'] == 'parda') ? 'checked' : '' ?> /><label for="parda">Parda</label>
          </div>
          <div class="form-check  form-check-inline">
            <input type="radio" name="cor" id="indigena" value="indigena" class="form-check-input" <?php echo ($pessoa['COR_RACA'] == 'indigena') ? 'checked' : '' ?> /><label for="indigena">Indígena</label>
          </div>
          <div class="form-check form-check-inline ">
            <input type="radio" name="cor" id="naoDeclarado" value="naoDeclarado" class="form-check-input" <?php echo ($pessoa['COR_RACA'] == 'naoDeclarado') ? 'checked' : '' ?> /><label for="naoDeclarado">Não Declarado</label>
          </div>
          <div class="form-check  form-check-inline">
            <input type="radio" name="cor" id="outra" value="outra" class="form-check-input" <?php echo ($pessoa['COR_RACA'] == 'outra') ? 'checked' : '' ?> /><label for="outra">Outra</label>
          </div>
        </div>
        <div class="mb-3">
          <label for="nacionalidade" class="form-label">Nacionalidade:</label>
          <input type="text" id="nacionalidade" name="nacionalidade" class="form-control bg-body-tertiary" value="<?php echo $pessoa['NACIONALIDADE']; ?>" required />
        </div>
        <div class="mb-3">
          <label for="naturalidade" class="form-label">Naturalidade:</label>
          <input type="text" id="naturalidade" name="naturalidade" class="form-control bg-body-tertiary" value="<?php echo $pessoa['NATURALIDADE']; ?>" required />
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" id="profissao" name="profissao" class="form-control bg-body-tertiary" value="<?php echo $pessoa['OCUPACAO_PROFISSIONAL']; ?>" required />
        </div>
        <div>
          <label for="renda" class="form-label">Renda</label>
          <input type="text" id="renda" name="renda" class="form-control bg-body-tertiary" value="<?php echo $pessoa['RENDA']; ?>" required />
        </div>
        <div class="mb-3">
          <label class="form-label">Ocupação Profissional:</label>
          <br>
          <div class="form-check form-check-inline">
            <input type="radio" name="ocupacao" id="clt" value="clt" class="form-check-input" <?php echo ($pessoa['OCUPACAO_PROFISSIONAL'] == 'clt') ? 'checked' : '' ?> required /><label for="clt">CLT</label>
          </div>
          <div class="form-check form-check-inline">
            <input type="radio" name="ocupacao" id="contrato" value="contrato" class="form-check-input" <?php echo ($pessoa['OCUPACAO_PROFISSIONAL'] == 'contratado') ? 'checked' : '' ?> /><label for="contrato">Contrato</label>
          </div>
          <div class="form-check form-check-inline">
            <input type="radio" name="ocupacao" id="autonomo" value="autonomo" class="form-check-input" <?php echo ($pessoa['OCUPACAO_PROFISSIONAL'] == 'autonomo') ? 'checked' : '' ?> /><label for="autonomo">Autônomo</label>
          </div>
          <div class="form-check form-check-inline">
            <input type="radio" name="ocupacao" id="desempregado" value="desempregado" class="form-check-input" <?php echo ($pessoa['OCUPACAO_PROFISSIONAL'] == 'desempregado') ? 'checked' : '' ?> /><label for="desempregado">Desempregado</label>
          </div>
          <div>
            <label for="outraOcupacao" class="form-label">Outra:</label>
            <input type="text" id="outraOcupacao" name="outraOcupacao" class="form-control bg-body-tertiary" value="<?php echo $pessoa['PROFISSAO']; ?>" />
          </div>
        </div>
      </div>
      ...
      <div class="mb-3 mt-4">
        <h5 class="text-center mb-3">Endereço/Contato</h5>
        <div>
          <div class="mb-3">
            <label for="cep" class="form-label">CEP</label>
            <input type="text" class="form-control bg-body-tertiary" id="cep" name="cep" value="<?php echo $pessoa['NUMERO_NIS']; ?>" required />
          </div>
          <div class="row mb-3">
            <div class="col-md-8">
              <label for="rua" class="form-label">Rua/Avenida</label>
              <input type="text" class="form-control bg-body-tertiary" id="rua" name="rua" value="<?php echo $pessoa['END_RUA']; ?>" required>
            </div>
            <div class="col-md-4">
              <label for="numero" class="form-label">Número:</label>
              <input type="text" class="form-control bg-body-tertiary" id="numero" name="numero" value="<?php echo $pessoa['END_NUM']; ?>" required>
            </div>
          </div>
          <div class="mb-3">
            <label for="bairro" class="form-label">Bairro</label>
            <input type="text" class="form-control bg-body-tertiary" id="bairro" name="bairro" value="<?php echo $pessoa['END_BAIRRO']; ?>" required>
          </div>
          <div class="mb-3">
            <label for="referencia" class="form-label">Ponto de Referência</label>
            <input type="text" class="form-control bg-body-tertiary" id="referencia" name="referencia" value="<?php echo $pessoa['END_P_REFERENCIA']; ?>" required>
          </div>
          <div class="mb-3">
            <label for="telefone" class="form-label">Telefone para contato</label>
            <input type="text" class="form-control bg-body-tertiary" id="telefone" name="telefone" value="<?php echo $pessoa['TELEFONE']; ?>" required>
          </div>
      ...
      <div class="mb-3 mt-4">
        <h5 class="text-center mb-3">Condições de Moradia</h5>
        ...
        <br>
        <div class="form-check form-check-inline">
          <input type="radio" name="tipoEstrutura" id="alvenaria" value="Alvenaria" class="form-check-input" <?php echo ($pessoa['ESTRUTURA_RESIDENCIA'] == 'alvenaria' ? 'checked' : '') ?> required />
        ...
        <div class="">
          ...
          <input type="text" id="outrosMateriais" name="outrosMateriais" class="form-control bg-body-tertiary" value="<?php echo $pessoa['OUTROS_MATERIAIS']; ?>" />
        </div>

        <label for="" class="form-label">Energia Elétrica:</label>
        <br>
        <div class="form-check">
          <input type="radio" name="energiaEletrica" id="comMedidorProprio" value="Com Medidor Próprio" class="form-check-input" <?php echo ($pessoa['ENERGIA_ELETRICA'] == 'COM MEDIDOR PRÓPRIO' ? 'checked' : '') ?> required />
        ...
        <div>
          ...
          <input type="text" id="outraFormaAgua" name="outraFormaAgua" class="form-control bg-body-tertiary" value="<?php echo $pessoa['OUTRA_FORMA_AGUA']; ?>" />
        </div>
        <label for="" class="form-label">Escoamento Sanitário:</label>
        <div>
          <input type="radio" name="escoamentoSanitario" id="redeGeralDistribuicaoSanitario" value="Rede Geral de Tratamento de Esgoto" class="form-check-input" <?php echo ($pessoa['ESCOA_SANITARIO'] == 'Rede Geral de Tratamento de Esgoto' ? 'checked' : '') ?> required />
        ...
        <div>
          ...
          <input type="text" id="outraFormaEsgoto" name="outraFormaEsgoto" class="form-control bg-body-tertiary" value="<?php echo $pessoa['OUTRA_FORMA_ESGOTO']; ?>" />
        </div>
        <div>
          <h5 class="text-center mt-4 mb-3">Benefícios Sociais</h5>
          <div class="form-check">
            <input type="radio" name="beneficiosSociais" id="naoBeneficiosSociais" value="Não" class="form-check-input" required <?php echo ($pessoa['BENEFICIOS_SOCIAIS'] == 'Não' ? 'checked' : '') ?> />
          ...
          <div>
            ...
            <input type="text" id="outroBeneficio" name="outroBeneficio" class="form-control bg-body-tertiary" value="<?php echo $pessoa['OUTROS_BENEFICIOS']; ?>" />
          </div>
        </div>
        <br>
        <div>
          ...
          <br>
          <div class="form-check form-check-inline">
            <input type="radio" name="situacaoCadastroUnico" id="naoPossuiCadastroUnico" value="Não Possui CAD Único" class="form-check-input" <?php echo ($pessoa['SIT_CAD_UNICO'] == 'Não Possui CAD Único' ? 'checked' : '') ?> required />
        ...
        <div class="mb-3 mt-4">
          <h5 class="text-center mb-3">Necessidades de Documentação Civil</h5>
          <div class="form-check">
        ...
        <div class="mb-3" id="dynamic-content">
          ...
          <div class="mb-2">
            ...
            <input type="text" id="nomesocio1" name="nomesocio[]" class="form-control bg-body-tertiary" value="<?php echo $pessoa['NOME_FAMILIAR']; ?>" />
          </div>
          <div class="mb-2">
            <label for="nomeCompletoSocio" class="form-label">Idade do Familiar:</label>
            <input type="text" id="idadesocio1" name="idadesocio[]" class="form-control bg-body-tertiary" value="<?php echo $pessoa['IDADE_FAMILIAR']; ?>" />
          </div>
          <div class="mb2">
        ...
        <script>
          ...
          function adicionarLinha() {
            ...
            newRow.innerHTML = `
      <h5 class="mt-3">Socioêconomico</h5>
      <div class="mb-2">
        <label for="nomeCompletoSocio" class="form-label">Nome Completo do Familiar:</label>
    ...
    `;
      ...
      <form>
        <div class="mb-3">
          <h5 class="text-center mb-3">Encaminhamentos/Agendamentos</h5>
          <div class="form-check">
