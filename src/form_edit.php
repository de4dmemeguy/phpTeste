...
<body>
  ...
  <div class="container">
    <h3 class="text-green text-center mt-4 mb-5">
      <img class="mb-3 logo" src="/CidadaniaEseguranca/img/Logo-SSP-Am-novo-300x298.png" alt="logo-ssp"><br>Formulário - Cidadania e Segurança
    </h3>
  </div>

  <form action="form_edit.php" method="post" id="myForm" onsubmit="return validarFormulario()" class="mb-4 mx-2">
    <div class="container border rounded-4 col-md-8 col-xl-4 shadow-lg bg-white">
      <div class="mx-auto">
        ...
        <div class="mx-3">
          ...
          <!-- <div class="mb-3">
          <label for="dataNascimento" class="form-label">Data de Nascimento:</label>
          <input type="date" id="dataNascimento" name="dataNascimento" class="form-control bg-body-tertiary" required/>
        </div> -->
          <div class="mb-3 col-6 col-md-4">
          ...
          <div class="mb-3">
            ...
            <input type="text" id="numNIS" name="numNIS" class="form-control bg-body-tertiary" value="<?php echo $pessoa['NUMERO_NIS']; ?>" />
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <div class="mb-3">
              <label for="outro" class="form-label">Outro: </label> <input type="text" name="outroEstadoCivil" id="outro" class="form-control bg-body-tertiary" value="<?php echo $pessoa['OUTRO_ESTADO_CIVIL']; ?>" />
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <input type="text" id="profissao" name="profissao" class="form-control bg-body-tertiary" value="<?php echo $pessoa['OCUPACAO_PROFISSIONAL']; ?>" />
          </div>
          <div class="mb-3">
            <label for="renda" class="form-label">Renda</label>
            <input type="text" id="renda" name="renda" class="form-control bg-body-tertiary" value="<?php echo $pessoa['RENDA']; ?>" />
          </div>
          <div class="mb-3">
      ...
      <div class="mb-3 mt-5">
        ...
        <div class="mx-3"><!-- espacamento dos campos -->
          <div class="mb-3 col-4">
            ...
            <input type="text" class="form-control bg-body-tertiary" id="cep" name="cep" value="<?php echo $pessoa['NUMERO_NIS']; ?>" />
          </div>
          <div class="row mb-3">
            <div class="col-md-8">
            ...
            <div class="col-md-4">
              ...
              <input type="text" class="form-control bg-body-tertiary" id="numero" name="numero" value="<?php echo $pessoa['END_NUM']; ?>">
            </div>
          </div>
          <div class="mb-3">
            <label for="bairro" class="form-label">Bairro</label>
            <input type="text" class="form-control bg-body-tertiary" id="bairro" name="bairro" value="<?php echo $pessoa['END_BAIRRO']; ?>">
          </div>
          <div class="mb-3">
            <label for="referencia" class="form-label">Ponto de Referência</label>
            <input type="text" class="form-control bg-body-tertiary" id="referencia" name="referencia" value="<?php echo $pessoa['END_P_REFERENCIA']; ?>">
          </div>
          <div class="mb-3 col-6 col-md-4">
            <label for="telefone" class="form-label">Telefone para contato</label>
            <input type="text" class="form-control bg-body-tertiary" id="telefone" name="telefone" value="<?php echo $pessoa['TELEFONE']; ?>">
          </div>
      ...
      <!-- SOCIOECONOMICO -->
      <div class="mb-3 mt-5" id="dynamic-content">
        <div class="border-bottom mb-3">
      ...
      <div class="container">
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" id="nomeCompletoTec" name="nomeCompletoTec" class="form-control bg-body-tertiary" value="<?php echo $pessoa['TECNICO_RESPONSAVEL']; ?>" required />
          </div>
