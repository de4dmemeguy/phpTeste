...
<html lang="pt-br">
  ...
  <div class="d-flex">
    ...
    ?>
        ...
        <a href='listar2.php?<?php echo (!empty($_GET['data']) ? "data=".$_GET['data']."&" : "")."pagina=1"; ?>' class='btn btn-outline-primary'>Primeira </a>
    <?php
        ...
        for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina -1; $pag_ant ++)
        {
            if($pag_ant >= 1 )
            {
                echo "<a href='listar2.php?".(!empty($_GET['data']) ? "data=".$_GET['data']."&" : "")."pagina=$pag_ant'>$pag_ant </a>";
            }
        ...
        for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep ++)
        {
            ...
            {
                echo "<a href='listar2.php?".(!empty($_GET['data']) ? "data=".$_GET['data']."&" : "")."pagina=$pag_dep'>$pag_dep </a>";
            }
        }
        echo "<a href='listar2.php?".(!empty($_GET['data']) ? "data=".$_GET['data']."&" : "")."pagina=$quantidade_pg' class='btn btn-outline-primary'> Ultima</a>";
